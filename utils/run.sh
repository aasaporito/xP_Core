...
~/Documents/xP_Core/src/Engine/xpilots -map ~/Documents/xP_Core/src/Engine/maps/core.xp -noquit -switchBase 1.0 +teamPlay -maxRoundTime 60 -roundsToPlay 0 +limitedLives -maxClientsPerIP 100  > /dev/null 2>&1 &
