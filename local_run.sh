...
~/Documents/xP_Core/Engine/xpilots -map ~/Documents/xP_Core/Engine/maps/core.xp -noquit -switchBase 1.0 +teamPlay -maxRoundTime 60 -roundsToPlay 0 -limitedLives -maxClientsPerIP 32  > /dev/null 2>&1 &
